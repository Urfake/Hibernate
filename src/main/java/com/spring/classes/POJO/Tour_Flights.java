...
public class Tour_Flights {
    ...
    private List<Air_Tickets> airTickets;

    public Tour_Flights() {
    }

    public Tour_Flights(String airLine, String arrivalCity, String beginningDate, String country, String departureCity, String departureDate, String departureTime, String directions, String endingDate, int flightCode, int programNumber, int tourNumber, String tourType) {
    ...
    public List<Air_Tickets> getAirTickets() {
        return airTickets;
    }

    public void setAirTickets(List<Air_Tickets> airTickets) {
